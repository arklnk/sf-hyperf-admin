 ...
 */
#[AnnotationCommand]
class ArkGenModel extends Command
{
    ...
    {
        parent::__construct('arkGen:model');
    ...
    public function handle()
    {
        ...
        $option->setPool($pool)
            ...
            ->setUses($this->getOption('uses', 'commands.gen:model.uses', $pool, 'App\Model\BaseModel'))
    ...
    {
        $this->setDescription('Create a new ark model');
